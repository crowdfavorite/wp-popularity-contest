...
- have image counter method for RSS return a valid (empty) image file
- report: single views not counting properly
*/
			...
			print('
					...
					<form name="ak_popularity" action="'.get_bloginfo('wpurl').'/wp-admin/options-general.php" method="post">
						<fieldset class="options">
							...
							<p>
								<label for="akpc_show_pop">'.__('Show popularity rank at the bottom of each post:', 'popularity-contest').'</label>
							...
							<p>
								<label for="akpc_show_rank_in_widget">'.__('Show popularity rank in widgets:', 'popularity-contest').'</label>
								<select name="show_rank_in_widget" id="akpc_show_rank_in_widget">
								'.$show_rank_in_widget_options.'
								</select>
							</p>
							<p>
...
function akpc_api_record_view($id = null) {
	...
	switch ($response) {
		case 'img':
			$img = trailingslashit(dirname(__FILE__)).'clear.gif';
			$file = fopen($img, 'rb');
